    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-white px-6 text-center">
        <div className="max-w-sm w-full">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Get Spot</h1>
          <p className="text-gray-500 mb-8">
            Save money and build credit with your community.
          </p>

          {/* iOS */}
          <div className="bg-gray-50 border border-gray-200 rounded-xl px-5 py-4 text-left mb-3">
            <p className="text-sm font-semibold text-gray-900 mb-1">Get Spot on iOS</p>
            <p className="text-sm text-gray-500 mb-3">Download via TestFlight.</p>
            <a
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl px-5 py-4 text-left">
            <p className="text-sm font-semibold text-gray-900 mb-1">Get Spot on Android</p>
            <p className="text-sm text-gray-500 mb-3">
              Spot is in private testing on Android. Enter your email and we&rsquo;ll
              add you to the testers list within 24&nbsp;hours.
            </p>
            {emailStatus === "sent" ? (
            ...
            <p className="text-xs text-gray-400 mt-4">
              Already been added?{" "}
              <a href={ANDROID_INTERNAL_TEST_URL} className="underline font-medium" style={{ color: "#007260" }}>
